...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        exerciseList.addElement(newElement: Exercise(title: "Isometric contraction", description: "Sit on the floor with your injured leg straight and your other leg bent. Contract the quadriceps of the injured knee without moving the leg. (Press down against the floor). Hold for 10 seconds. Relax. Repeat 10 times.", assigned: false))
        exerciseList.addElement(newElement: Exercise(title: "Half-Squat", description: "Stand holding a sturdy table with both hands. With your feet placed shoulder’s width apart, slowly bend your knees and squat, lowering your hips into a half-squat. Hold 10 seconds and then slowly return to a standing position. Repeat 10 times.", assigned: false))
        exerciseList.addElement(newElement: Exercise(title: "Partial Lunges", description: "Stand holding a sturdy table with both hands. With your feet placed shoulder’s width apart, take a half step forward, keeping your weight evenly distributed. Slowly bend your knees and sink down slightly. Hold 10 seconds and then slowly return to a standing position. Repeat on the other side. Do 10 times per side.", assigned: false))
        exerciseList.addElement(newElement: Exercise(title: "Heel Raises", description: "While standing, place your hand on a counter or back of a chair for balance. Raise up onto your toes and hold for five seconds. Slowly lower your heel to the floor and repeat 10 times.", assigned: false))
